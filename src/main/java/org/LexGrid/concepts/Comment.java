...
public class Comment  extends org.LexGrid.commonTypes.Property  implements java.io.Serializable {
    public Comment() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:concepts.LexGrid.org", "Comment"));
    }
